class User < ActiveRecord::Base
  ...
  validates_exclusion_of :name, :in => %w( inboxes message discussions search facebook tedx users feeds photos videos items oembed api facebook new popular featured favicon superuser 
